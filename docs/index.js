...
/* harmony export */ });
/* unused harmony exports getFortuneTellings, getSearchData */
...
function getArticles() {
  return new Promise(function (resolve) {
    resolve(_data_articles_json__WEBPACK_IMPORTED_MODULE_0__);
  });
}
...
;// ./src/components/O_BlockOfTarotCards/O_BlockOfTarotCards.jsx
...
;// ./src/components/M_ArticleCard/M_ArticleCard.jsx
function M_ArticleCard_typeof(obj) { "@babel/helpers - typeof"; return M_ArticleCard_typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (obj) { return typeof obj; } : function (obj) { return obj && "function" == typeof Symbol && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }, M_ArticleCard_typeof(obj); }
function M_ArticleCard_classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }
function M_ArticleCard_defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } }
function M_ArticleCard_createClass(Constructor, protoProps, staticProps) { if (protoProps) M_ArticleCard_defineProperties(Constructor.prototype, protoProps); if (staticProps) M_ArticleCard_defineProperties(Constructor, staticProps); Object.defineProperty(Constructor, "prototype", { writable: false }); return Constructor; }
function M_ArticleCard_inherits(subClass, superClass) { if (typeof superClass !== "function" && superClass !== null) { throw new TypeError("Super expression must either be null or a function"); } subClass.prototype = Object.create(superClass && superClass.prototype, { constructor: { value: subClass, writable: true, configurable: true } }); Object.defineProperty(subClass, "prototype", { writable: false }); if (superClass) M_ArticleCard_setPrototypeOf(subClass, superClass); }
function M_ArticleCard_setPrototypeOf(o, p) { M_ArticleCard_setPrototypeOf = Object.setPrototypeOf ? Object.setPrototypeOf.bind() : function _setPrototypeOf(o, p) { o.__proto__ = p; return o; }; return M_ArticleCard_setPrototypeOf(o, p); }
function M_ArticleCard_createSuper(Derived) { var hasNativeReflectConstruct = M_ArticleCard_isNativeReflectConstruct(); return function _createSuperInternal() { var Super = M_ArticleCard_getPrototypeOf(Derived), result; if (hasNativeReflectConstruct) { var NewTarget = M_ArticleCard_getPrototypeOf(this).constructor; result = Reflect.construct(Super, arguments, NewTarget); } else { result = Super.apply(this, arguments); } return M_ArticleCard_possibleConstructorReturn(this, result); }; }
function M_ArticleCard_possibleConstructorReturn(self, call) { if (call && (M_ArticleCard_typeof(call) === "object" || typeof call === "function")) { return call; } else if (call !== void 0) { throw new TypeError("Derived constructors may only return object or undefined"); } return M_ArticleCard_assertThisInitialized(self); }
function M_ArticleCard_assertThisInitialized(self) { if (self === void 0) { throw new ReferenceError("this hasn't been initialised - super() hasn't been called"); } return self; }
function M_ArticleCard_isNativeReflectConstruct() { if (typeof Reflect === "undefined" || !Reflect.construct) return false; if (Reflect.construct.sham) return false; if (typeof Proxy === "function") return true; try { Boolean.prototype.valueOf.call(Reflect.construct(Boolean, [], function () {})); return true; } catch (e) { return false; } }
function M_ArticleCard_getPrototypeOf(o) { M_ArticleCard_getPrototypeOf = Object.setPrototypeOf ? Object.getPrototypeOf.bind() : function _getPrototypeOf(o) { return o.__proto__ || Object.getPrototypeOf(o); }; return M_ArticleCard_getPrototypeOf(o); }



var M_ArticleCard = /*#__PURE__*/function (_React$Component) {
  M_ArticleCard_inherits(M_ArticleCard, _React$Component);
  var _super = M_ArticleCard_createSuper(M_ArticleCard);
  function M_ArticleCard() {
    M_ArticleCard_classCallCheck(this, M_ArticleCard);
    return _super.apply(this, arguments);
  }
  M_ArticleCard_createClass(M_ArticleCard, [{
    key: "render",
    value: function render() {
      var _this$props = this.props,
        link = _this$props.link,
      ...
      return /*#__PURE__*/react.createElement("a", {
        ...
        className: "M_CardArticle"
      }, /*#__PURE__*/react.createElement("div", {
        className: "A_CardArticleImage",
        style: {
          backgroundImage: "url(".concat(__webpack_require__(1089)("./" + image), ")")
        }
      }, /*#__PURE__*/react.createElement("div", {
  ...
  return M_ArticleCard;
}(react.Component);

;// ./src/components/O_BlockOfArticles/O_BlockOfArticles.jsx
function O_BlockOfArticles_typeof(obj) { "@babel/helpers - typeof"; return O_BlockOfArticles_typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (obj) { return typeof obj; } : function (obj) { return obj && "function" == typeof Symbol && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }, O_BlockOfArticles_typeof(obj); }
function O_BlockOfArticles_classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }
function O_BlockOfArticles_defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } }
function O_BlockOfArticles_createClass(Constructor, protoProps, staticProps) { if (protoProps) O_BlockOfArticles_defineProperties(Constructor.prototype, protoProps); if (staticProps) O_BlockOfArticles_defineProperties(Constructor, staticProps); Object.defineProperty(Constructor, "prototype", { writable: false }); return Constructor; }
function O_BlockOfArticles_inherits(subClass, superClass) { if (typeof superClass !== "function" && superClass !== null) { throw new TypeError("Super expression must either be null or a function"); } subClass.prototype = Object.create(superClass && superClass.prototype, { constructor: { value: subClass, writable: true, configurable: true } }); Object.defineProperty(subClass, "prototype", { writable: false }); if (superClass) O_BlockOfArticles_setPrototypeOf(subClass, superClass); }
function O_BlockOfArticles_setPrototypeOf(o, p) { O_BlockOfArticles_setPrototypeOf = Object.setPrototypeOf ? Object.setPrototypeOf.bind() : function _setPrototypeOf(o, p) { o.__proto__ = p; return o; }; return O_BlockOfArticles_setPrototypeOf(o, p); }
function O_BlockOfArticles_createSuper(Derived) { var hasNativeReflectConstruct = O_BlockOfArticles_isNativeReflectConstruct(); return function _createSuperInternal() { var Super = O_BlockOfArticles_getPrototypeOf(Derived), result; if (hasNativeReflectConstruct) { var NewTarget = O_BlockOfArticles_getPrototypeOf(this).constructor; result = Reflect.construct(Super, arguments, NewTarget); } else { result = Super.apply(this, arguments); } return O_BlockOfArticles_possibleConstructorReturn(this, result); }; }
function O_BlockOfArticles_possibleConstructorReturn(self, call) { if (call && (O_BlockOfArticles_typeof(call) === "object" || typeof call === "function")) { return call; } else if (call !== void 0) { throw new TypeError("Derived constructors may only return object or undefined"); } return O_BlockOfArticles_assertThisInitialized(self); }
function O_BlockOfArticles_assertThisInitialized(self) { if (self === void 0) { throw new ReferenceError("this hasn't been initialised - super() hasn't been called"); } return self; }
function O_BlockOfArticles_isNativeReflectConstruct() { if (typeof Reflect === "undefined" || !Reflect.construct) return false; if (Reflect.construct.sham) return false; if (typeof Proxy === "function") return true; try { Boolean.prototype.valueOf.call(Reflect.construct(Boolean, [], function () {})); return true; } catch (e) { return false; } }
function O_BlockOfArticles_getPrototypeOf(o) { O_BlockOfArticles_getPrototypeOf = Object.setPrototypeOf ? Object.getPrototypeOf.bind() : function _getPrototypeOf(o) { return o.__proto__ || Object.getPrototypeOf(o); }; return O_BlockOfArticles_getPrototypeOf(o); }




var O_BlockOfArticles = /*#__PURE__*/function (_React$Component) {
  O_BlockOfArticles_inherits(O_BlockOfArticles, _React$Component);
  var _super = O_BlockOfArticles_createSuper(O_BlockOfArticles);
  function O_BlockOfArticles() {
    O_BlockOfArticles_classCallCheck(this, O_BlockOfArticles);
    return _super.apply(this, arguments);
  }
  O_BlockOfArticles_createClass(O_BlockOfArticles, [{
    key: "render",
    value: function render() {
      var data = this.props.data;
      var ArticlesCollection = data.map(function (article, i) {
        return /*#__PURE__*/react.createElement(M_ArticleCard, {
          link: article.link,
          title: article.title,
      ...
      return /*#__PURE__*/react.createElement("div", {
        className: "O_BlockOfArticles"
      }, ArticlesCollection);
    }
  }]);
  return O_BlockOfArticles;
}(react.Component);
...
document.addEventListener('DOMContentLoaded', function () {
  ...
  (0,airtableData/* getTarotCards */.YF)().then(function (data) {
    var root = (0,client/* createRoot */.H)(document.querySelector('.W_FortuneTellings'));
    var requiredCards = [];
    var tarotCards = data.slice();
    for (var i = 0; i < N; i++) {
  ...
  (0,airtableData/* getArticles */.GE)().then(function (data) {
    var root = (0,client/* createRoot */.H)(document.querySelector('.W_ArticleCardsIndex'));
    var requiredArticles = [];
    var Articles = data.slice();
    for (var i = 0; i < B; i++) {
    ...
    root.render(/*#__PURE__*/react.createElement("div", null, /*#__PURE__*/react.createElement(O_BlockOfArticles, {
      data: requiredArticles
    })));
  });
});
})();
