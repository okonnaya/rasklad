...
;// ./src/components/O_TarotCardInfo/O_TarotCardInfo.jsx
function O_TarotCardInfo_typeof(obj) { "@babel/helpers - typeof"; return O_TarotCardInfo_typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (obj) { return typeof obj; } : function (obj) { return obj && "function" == typeof Symbol && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }, O_TarotCardInfo_typeof(obj); }
function O_TarotCardInfo_classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }
function O_TarotCardInfo_defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } }
function O_TarotCardInfo_createClass(Constructor, protoProps, staticProps) { if (protoProps) O_TarotCardInfo_defineProperties(Constructor.prototype, protoProps); if (staticProps) O_TarotCardInfo_defineProperties(Constructor, staticProps); Object.defineProperty(Constructor, "prototype", { writable: false }); return Constructor; }
function O_TarotCardInfo_inherits(subClass, superClass) { if (typeof superClass !== "function" && superClass !== null) { throw new TypeError("Super expression must either be null or a function"); } subClass.prototype = Object.create(superClass && superClass.prototype, { constructor: { value: subClass, writable: true, configurable: true } }); Object.defineProperty(subClass, "prototype", { writable: false }); if (superClass) O_TarotCardInfo_setPrototypeOf(subClass, superClass); }
function O_TarotCardInfo_setPrototypeOf(o, p) { O_TarotCardInfo_setPrototypeOf = Object.setPrototypeOf ? Object.setPrototypeOf.bind() : function _setPrototypeOf(o, p) { o.__proto__ = p; return o; }; return O_TarotCardInfo_setPrototypeOf(o, p); }
function O_TarotCardInfo_createSuper(Derived) { var hasNativeReflectConstruct = O_TarotCardInfo_isNativeReflectConstruct(); return function _createSuperInternal() { var Super = O_TarotCardInfo_getPrototypeOf(Derived), result; if (hasNativeReflectConstruct) { var NewTarget = O_TarotCardInfo_getPrototypeOf(this).constructor; result = Reflect.construct(Super, arguments, NewTarget); } else { result = Super.apply(this, arguments); } return O_TarotCardInfo_possibleConstructorReturn(this, result); }; }
function O_TarotCardInfo_possibleConstructorReturn(self, call) { if (call && (O_TarotCardInfo_typeof(call) === "object" || typeof call === "function")) { return call; } else if (call !== void 0) { throw new TypeError("Derived constructors may only return object or undefined"); } return O_TarotCardInfo_assertThisInitialized(self); }
function O_TarotCardInfo_assertThisInitialized(self) { if (self === void 0) { throw new ReferenceError("this hasn't been initialised - super() hasn't been called"); } return self; }
function O_TarotCardInfo_isNativeReflectConstruct() { if (typeof Reflect === "undefined" || !Reflect.construct) return false; if (Reflect.construct.sham) return false; if (typeof Proxy === "function") return true; try { Boolean.prototype.valueOf.call(Reflect.construct(Boolean, [], function () {})); return true; } catch (e) { return false; } }
function O_TarotCardInfo_getPrototypeOf(o) { O_TarotCardInfo_getPrototypeOf = Object.setPrototypeOf ? Object.getPrototypeOf.bind() : function _getPrototypeOf(o) { return o.__proto__ || Object.getPrototypeOf(o); }; return O_TarotCardInfo_getPrototypeOf(o); }




var O_TarotCardInfo = /*#__PURE__*/function (_React$Component) {
  O_TarotCardInfo_inherits(O_TarotCardInfo, _React$Component);
  var _super = O_TarotCardInfo_createSuper(O_TarotCardInfo);
  function O_TarotCardInfo() {
    O_TarotCardInfo_classCallCheck(this, O_TarotCardInfo);
    return _super.apply(this, arguments);
  }
  O_TarotCardInfo_createClass(O_TarotCardInfo, [{
    key: "render",
    value: function render() {
      var _this$props = this.props,
...
document.addEventListener('DOMContentLoaded', function () {
  ...
  (0,airtableData/* getTarotCards */.YF)().then(function (data) {
    ...
    var requiredCard;
    allTarotCards.forEach(function (tarotCard) {
      if (tarotCard.htmlname == filename) {
        requiredCard = tarotCard;
      }
    });
    var root = (0,client/* createRoot */.H)(document.querySelector('.CardContainer'));
    root.render(/*#__PURE__*/react.createElement(O_TarotCardInfo, {
