...
var O_BlockOfTarotCards = __webpack_require__(6496);
...
;// ./src/components/A_Input/A_Input.jsx
...
;// ./src/components/A_SearchButton/A_SearchButton.jsx
...
;// ./src/components/M_SearchBar/M_SearchBar.jsx
...
;// ./src/components/A_MenuLogo/A_MenuLogo.jsx
...
;// ./src/components/A_MenuMobileToggle/A_MenuMobileToggle.jsx
...
;// ./src/components/O_MenuBar/O_Menubar.jsx
...
var search = __webpack_require__(5016);
;// ./src/cards.jsx
...
document.addEventListener('DOMContentLoaded', function () {
  (0,airtableData/* getTarotCards */.YF)().then(function (data) {
    tarotCards = data;
    var root = (0,client/* createRoot */.H)(document.querySelector('.Major'));
    var requiredCards = [];
    ...
    root.render(/*#__PURE__*/react.createElement("div", null, /*#__PURE__*/react.createElement(O_BlockOfTarotCards/* default */.A, {
      data: requiredCards
    })));
  });
});
document.addEventListener('DOMContentLoaded', function () {
  (0,airtableData/* getTarotCards */.YF)().then(function (data) {
    tarotCards = data;
    var root = (0,client/* createRoot */.H)(document.querySelector('.Swords'));
    var requiredCards = [];
    tarotCards.forEach(function (card) {
...
document.addEventListener('DOMContentLoaded', function () {
  (0,airtableData/* getTarotCards */.YF)().then(function (data) {
    tarotCards = data;
    var root = (0,client/* createRoot */.H)(document.querySelector('.Cups'));
    var requiredCards = [];
    tarotCards.forEach(function (card) {
      if (card.arcana === 'cups') {
        requiredCards.push(card);
...
document.addEventListener('DOMContentLoaded', function () {
  (0,airtableData/* getTarotCards */.YF)().then(function (data) {
    tarotCards = data;
    var root = (0,client/* createRoot */.H)(document.querySelector('.Wands'));
    var requiredCards = [];
    tarotCards.forEach(function (card) {
...
document.addEventListener('DOMContentLoaded', function () {
  (0,airtableData/* getTarotCards */.YF)().then(function (data) {
    tarotCards = data;
    var root = (0,client/* createRoot */.H)(document.querySelector('.Pentacles'));
    var requiredCards = [];
    tarotCards.forEach(function (card) {
