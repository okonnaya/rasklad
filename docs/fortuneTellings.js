...
/* harmony export */   uD: () => (/* binding */ getFortuneTellings)
/* harmony export */ });
/* unused harmony exports getArticles, getTarotCards, getSearchData */
...
function getFortuneTellings() {
  return new Promise(function (resolve) {
    resolve(_data_fortuneTellings_json__WEBPACK_IMPORTED_MODULE_1__);
  });
}
...
document.addEventListener('DOMContentLoaded', function () {
  (0,airtableData/* getFortuneTellings */.uD)().then(function (data) {
    tellings = data;
